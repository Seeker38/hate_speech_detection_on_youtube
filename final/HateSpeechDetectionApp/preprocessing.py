...
""" emoji """
c2e_path = os.path.join(os.getcwd(), 'HateSpeechDetectionApp\\dictionary\\character2emoji.xlsx')
...
e2w_path = os.path.join(os.getcwd(), 'HateSpeechDetectionApp\\dictionary\\emoji2word.xlsx')
...
""" abbreviation """
adn_path = os.path.join(os.getcwd(), 'HateSpeechDetectionApp\\dictionary\\abb_dict_normal.xlsx')
...
ads_path = os.path.join(os.getcwd(), 'HateSpeechDetectionApp\\dictionary\\abb_dict_special.xlsx')
...
def abbreviation_predict(t):
    model_path = os.path.join(os.getcwd(), 'HateSpeechDetectionApp\\abb_model.sav')
    loaded_model = joblib.load(model_path)

    da_path = os.path.join(os.getcwd(), 'HateSpeechDetectionApp\\dictionary\\abbreviation_dictionary_vn.xlsx')
    train_path = os.path.join(os.getcwd(), 'HateSpeechDetectionApp\\dictionary\\train_duplicate_abb_data.xlsx')
    dev_path = os.path.join(os.getcwd(), 'HateSpeechDetectionApp\\dictionary\\dev_duplicate_abb_data.xlsx')
    test_path = os.path.join(os.getcwd(), 'HateSpeechDetectionApp\\dictionary\\test_duplicate_abb_data.xlsx')
